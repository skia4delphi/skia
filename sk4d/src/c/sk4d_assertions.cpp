...
static_assert(sizeof(SkSurfaceProps) == 16, "");
    ...
    static_assert(sizeof(SkPDF::Metadata) == 96, "");
#else
    static_assert(sizeof(SkImageInfo)     == 24,  "");
    static_assert(sizeof(SkPDF::Metadata) == 152, "");
#endif
#if SK_GANESH
    #ifndef SK_ARCH_64BIT
        static_assert(sizeof(GrContextOptions) == 112, "");
    #else
...
// Custom mappings
static_assert(static_cast<int>(kLastEnum_SkColorType) == 28, "");
