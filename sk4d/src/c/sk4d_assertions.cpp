...
static_assert(sizeof(SkPDF::DateTime)                   == sizeof(sk_datetime_t),                       "");
...
// Custom mappings
static_assert(sizeof(SkFontStyle)    == 4,  "");
static_assert(sizeof(SkMatrix)       == 40, "");
static_assert(sizeof(SkM44)          == 64, "");
static_assert(sizeof(SkSurfaceProps) == 16, "");
#ifndef SK_ARCH_64BIT
    static_assert(sizeof(SkImageInfo)     == 20,  "");
    static_assert(sizeof(SkPDF::Metadata) == 80, "");
#else
    static_assert(sizeof(SkImageInfo)     == 24,  "");
    static_assert(sizeof(SkPDF::Metadata) == 128, "");
#endif
#if SK_GANESH
    #ifndef SK_ARCH_64BIT
        static_assert(sizeof(GrContextOptions) == 144, "");
    #else
        static_assert(sizeof(GrContextOptions) == 176, "");
    #endif
    #ifdef SK_GL
        static_assert(sizeof(GrGLFramebufferInfo) == 12, "");
        static_assert(sizeof(GrGLTextureInfo)     == 16, "");
    #endif

    #ifdef SK_VULKAN
        static_assert(sizeof(skgpu::VulkanYcbcrConversionInfo) == 64, "");
        #ifndef SK_ARCH_64BIT
            static_assert(sizeof(GrVkImageInfo)      == 152, "");
            static_assert(sizeof(skgpu::VulkanAlloc) == 40,  "");
            #ifdef SK_BUILD_FOR_ANDROID
              static_assert(sizeof(skgpu::VulkanBackendContext) == 80, "");
            #else
              static_assert(sizeof(skgpu::VulkanBackendContext) == 96, "");
            #endif
        #else
            static_assert(sizeof(GrVkImageInfo)               == 160, "");
            static_assert(sizeof(skgpu::VulkanAlloc)          == 48,  "");
            static_assert(sizeof(skgpu::VulkanBackendContext) == 160, "");
        #endif
    #endif

    #ifdef SK_METAL
        static_assert(sizeof(GrMtlBackendContext) == 16, "");
        static_assert(sizeof(GrMtlTextureInfo)    == 8,  "");
    #endif
#endif
...
static_assert(static_cast<int>(kLastEnum_SkAlphaType) == static_cast<int>(UNPREMUL_SK_ALPHATYPE), "");
...
static_assert(static_cast<int>(SkBlendMode::kLastMode)          == static_cast<int>(LUMINOSITY_SK_BLENDMODE),  "");
...
static_assert(static_cast<int>(kLastEnum_SkBlurStyle) == static_cast<int>(INNER_SK_BLURSTYLE),  "");
...
static_assert(static_cast<int>(SkClipOp::kMax_EnumValue) == static_cast<int>(INTERSECT_SK_CLIPOP),  "");
...
static_assert(static_cast<int>(SkColorChannel::kLastEnum) == static_cast<int>(A_SK_COLORCHANNEL), "");
...
static_assert(static_cast<int>(SkFilterMode::kLast)    == static_cast<int>(LINEAR_SK_FILTERMODE),  "");
...
static_assert(static_cast<int>(SkHighContrastConfig::InvertStyle::kLast)             == static_cast<int>(INVERT_LIGHTNESS_SK_CONTRASTINVERTSTYLE),  "");
...
static_assert(static_cast<int>(SkMipmapMode::kLast)    == static_cast<int>(LINEAR_SK_MIPMAPMODE),  "");
...
static_assert(static_cast<int>(SkPaint::kLast_Cap)    == static_cast<int>(SQUARE_SK_STROKECAP), "");
static_assert(static_cast<int>(SkPaint::kDefault_Cap) == static_cast<int>(BUTT_SK_STROKECAP),   "");
...
static_assert(static_cast<int>(SkPaint::kLast_Join)     == static_cast<int>(BEVEL_SK_STROKEJOIN), "");
static_assert(static_cast<int>(SkPaint::kDefault_Join)  == static_cast<int>(MITER_SK_STROKEJOIN), "");
...
static_assert(static_cast<int>(SkPath1DPathEffect::kLastEnum_Style)  == static_cast<int>(MORPH_SK_PATHEFFECT1DSTYLE),     "");
...
static_assert(static_cast<int>(SkRegion::kLastOp)               == static_cast<int>(REPLACE_SK_REGIONOP),            "");
...
static_assert(static_cast<int>(SkVertices::kLast_VertexMode)          == static_cast<int>(TRIANGLE_FAN_SK_VERTEXMODE),   "");

// Custom mappings
static_assert(static_cast<int>(kLastEnum_SkColorType) == 26, "");
    ...
    // GrSyncCpu
    static_assert(std::is_same<std::underlying_type_t<GrSyncCpu>, bool>::value, "");

    // Budgeted
    static_assert(std::is_same<std::underlying_type_t<skgpu::Budgeted>, bool>::value, "");
