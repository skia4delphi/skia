...
sk_colorfilter_t* sk4d_colorfilter_make_blend2(const sk_color4f_t* color, sk_colorspace_t* color_space, sk_blendmode_t mode) {
...
sk_colorfilter_t* sk4d_colorfilter_make_table(const uint8_t* tablea_a, const uint8_t* tablea_r, const uint8_t* tablea_g, const uint8_t* tablea_b) {
    return ToColorFilter(SkColorFilters::TableARGB(tablea_a, tablea_r, tablea_g, tablea_b).release());
}
