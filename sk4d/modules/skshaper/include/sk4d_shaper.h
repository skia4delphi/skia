...
SK4D_API sk_textblob_t* sk4d_shaper_shape(const sk_shaper_t* self, const char text[], const sk_font_t* font, bool left_to_right, float width, const sk_point_t* offset, sk_point_t* end_point);
