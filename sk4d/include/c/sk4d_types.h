...
// TODO: This structure has new fields; consider creating a version with 'Ex'
// suffix and implementing overloads.
typedef struct {
    const char*   title;
    const char*   author;
    const char*   subject;
...
// TODO: Review the options, ensuring consideration of the newly added fields
// 'fMinimumStagingBufferSize', 'fSharpenMipmappedTextures',
// 'fVulkanVMALargeHeapBlockSize', 'fDisableTessellationPathRenderer',
// introduced in the latest Skia update.
typedef struct {
...
// DEPRECATED: The field 'binary_archive' is no longer in use.
typedef struct {
